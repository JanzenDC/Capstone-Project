  ...
  class API{
    ...
    public function httpPost($payload)
    {
        try {
            ...
            $apiKey = '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';
            ...
            $absoluteFilePath = __DIR__ . '/' . $zipFileName; // Construct absolute file path
            header('Content-Type: application/octet-stream');
            header('Content-Disposition: attachment; filename="' . $zipFileName . '"');
            header('Content-Length: ' . filesize($absoluteFilePath)); // Add this line to indicate the file size
            ...
            $response = ['status' => 'success', 'message' => 'Backup file sent successfully.'];
            echo json_encode($response);
            exit;
        } catch (Exception $e) {
            // Send fail response
